...
vcs -sverilog -full64 -debug_all tests/fft8_tb_top.sv rtl/fft8_if.sv rtl/fft8.sv tests/fft8_tb.sv -o build/f_sim/fft8.simv > build/f_sim/fft8_compilation.txt
